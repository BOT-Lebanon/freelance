...
Route::group(['prefix' => 'admin', 'namespace'=>'Admin'], function () {
    ...
    Route::get('getcazamultiple/{provinceId}', 'UsersController@getcaza')->name('getcazamultiple');
    Route::get('getcitymultiple/{kadaaId}', 'UsersController@getcity')->name('getcitymultiple');
...
Route::group(['prefix' => 'admin', 'middleware' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::get('/index2', 'JoshController@showIndex2')->name('index2');
    # crop demo
...
Route::group(['prefix' => 'admin','namespace'=>'Admin', 'middleware' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group([ 'prefix' => 'users'], function () {
        ...
        Route::get('dataemployees', 'UsersController@dataemployees')->name('users.dataemployees');
...
//        Route::post('passwordreset', 'UsersController@passwordreset')->name('passwordreset');
    ...
    Route::post('sendmailusers', 'UsersController@sendmailusers')->name('sendmailusers');
    ...
    # SelectFilter
    Route::get('selectfilter', 'selectFilterController@typeaheadIndex')->name('selectfilter');
    Route::get('selectfilter/find', 'selectFilterController@typeahead')->name('selectfilter.find');
...
//Route::get('register', 'FrontEndController@getRegisterauth')->name('register');
Route::get('register', 'FrontEndController@getRegister')->name('register');

Route::post('registerauth', 'FrontEndController@getRegisterauth')->name('registerauth');
Route::get('checkphonenumber/{phone}', 'FrontEndController@checkphoneifexist')->name('registerauth');
Route::post('updateuser', 'FrontEndController@updateonRegister')->name('updateuser');
Route::post('updateuserskills/{userId}', 'FrontEndController@updateuserskills')->name('updateuserskills');
Route::post('updateuser2', 'FrontEndController@updateonRegister2')->name('updateuser2');
Route::post('registeruser','FrontEndController@postRegister')->name('registeruser');
Route::get('getcaza/{provinceId}', 'FrontEndController@getcaza')->name('getcaza');

Route::get('getcity/{kadaaId}', 'FrontEndController@getcity')->name('getcity');
Route::post('updateeducation', 'FrontEndController@updateeducation')->name('updateeducation');

Route::get('educationusers/{userId}', 'FrontEndController@geteducationuser')->name('geteducationuser');
Route::get('educationuser/{educationId}', 'FrontEndController@geteducation')->name('educationuser');
Route::get('educationuser/delete/{educationId}/{userId}', 'FrontEndController@deleteeducation')->name('deleteeducation');
Route::post('updatetraining', 'FrontEndController@updatetraining')->name('updatetraining');
Route::get('traininguser/{Id}', 'FrontEndController@gettraining')->name('traininguser');
Route::get('traininguser/delete/{Id}/{userId}', 'FrontEndController@deletetraining')->name('deletetraining');
Route::get('trainingsusers/{userId}', 'FrontEndController@gettraininguser')->name('gettraininguser');
...
Route::get('checkemail/{email}','FrontEndController@checkemail')->name('checkemail');
Route::get('checkextension/{pic}','FrontEndController@checkextension')->name('checkextension');

Route::get('checkalloweduser/{phone}','FrontEndController@checkalloweduser')->name('checkalloweduser');
Route::get('autocompleteinstitution', 'FrontEndController@autocompleteInstitution');
Route::get('autocompletecourse', 'FrontEndController@autocompleteTrainingCourse');
//libanpost
Route::post('updatelibanpost', 'FrontEndController@updatelibanpost')->name('updatelibanpost');
Route::get('edituser/{userId}', 'FrontEndController@edituser')->name('edituser');
 ...
 */
    ...
    Route::get('my-projects', 'FrontEndController@myProjects')->name('my-projects');
    Route::get('account-account', 'FrontEndController@AccountManager')->name('account-account');
    Route::get('libanpost', ['as'=> 'libanpost', 'uses' => 'FrontEndController@getLibanpost']);
	Route::get('inbox', ['as'=> 'inbox.index', 'uses' => 'CorrespondanceController@index']);
	Route::post('inbox', ['as'=> 'inbox.store', 'uses' => 'CorrespondanceController@store']);
	Route::get('sent', ['as'=> 'inbox.sent', 'uses' => 'CorrespondanceController@sent']);
	Route::get('viewmail/{correspondance}', ['as'=> 'inbox.viewmail', 'uses' => 'CorrespondanceController@show']);
    Route::get('reply/{correspondance}', ['as'=> 'inbox.replymail', 'uses' => 'CorrespondanceController@reply']);
    Route::post('sendreply', ['as'=> 'sendreply', 'uses' => 'CorrespondanceController@sendreply']);
