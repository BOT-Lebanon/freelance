...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Advanced Datatables 2</li>
        </ol>
    </section>
    <!--section ends-->
                ...
                <div class="panel panel-success filterable">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="material-icons">tablet</i> Dropdown column searching
                        </h3>
                    </div>
                ...
                <div class="panel panel-info filterable">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left">
                            <i class="material-icons">card_giftcard</i> Child rows
                        </h3>
                    </div>
                ...
                <div class="panel panel-primary filterable">
                    <div class="panel-heading clearfix  ">
                        <div class="panel-title pull-left">
                            <div class="caption">
                                <i class="material-icons">camera_alt</i> Show / hide columns dynamically
                            </div>
                        </div>
                    </div>
                    <div class="panel-body table-responsive">
                        ...
                        <div class="btn-group">
                            ...
                            <button type="button" class="toggle-vis btn btn-default" data-column="3">User E-mail
                            </button>
            ...
            <div class="col-lg-12">
                <div class="panel panel-primary filterable">
                    <div class="panel-heading clearfix  ">
                        <div class="panel-title pull-left">
                            <div class="caption">
                                <i class="material-icons">camera_alt</i> Form fields inside the table
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="panel-body table-responsive">
                            <table class="table table-striped table-bordered diaplay" id="table4">
                                <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Age</th>
                                ...
                                <tr>
                                    <td>Tiger Nixon</td>
                                    <td>
                                        <input type="text" class="form-control" id="row-2-age" name="row-2-age" value="61">
                                    </td>
                                    <td>
