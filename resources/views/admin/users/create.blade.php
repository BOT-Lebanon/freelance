            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <!--main content-->
                        <form name="commentForm" id="commentForm" action="{{ route('admin.users.store') }}"
...
@section('footer_scripts')
    ...
    <script src="{{ asset('vendors/bootstrapwizard/jquery.bootstrap.wizard.js') }}"
            type="text/javascript"></script>
    <script src="{{ asset('vendors/bootstrapvalidator/js/bootstrapValidator.min.js') }}"
            type="text/javascript"></script>
