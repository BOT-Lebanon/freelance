            ...
            <div class="col-md-12">
                ...
                <div class="portlet box primary">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="material-icons">flip</i> Responsive Flip Scroll Tables
                        </div>
                    </div>
                    <div class="portlet-body flip-scroll">
                        <table class="table table-bordered table-striped table-condensed flip-content" id="flip">
                ...
                <div class="portlet box default">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="material-icons">edit</i> Basic Responsive Table
                        </div>
                    </div>
                ...
                <div class="portlet box warning">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="material-icons">blur_circular</i> Bordered Responsive Table
                        </div>
                    </div>
                    <div class="portlet-body">
                ...
                <div class="portlet box info">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="material-icons">local_offer</i> Responsive Table
                        </div>
                    </div>
                    <div class="portlet-body">
                ...
                <div class="portlet box danger">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="material-icons">notifications</i> Horizontal Scrollable
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-scrollable">
                            <table class="table table-striped table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th scope="col" class="horizontal-head">Table Header 1</th>
