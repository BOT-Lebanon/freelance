...
@section('header_styles')
    <link rel="stylesheet" type="text/css"
          href="{{ asset('vendors/datatables/css/dataTables.bootstrap.css') }}"/>
    <link rel="stylesheet" type="text/css" href="{{ asset('vendors/datatables/css/buttons.bootstrap.css') }}"/>
    <link rel="stylesheet" type="text/css"
          href="{{ asset('vendors/datatables/css/colReorder.bootstrap.css') }}"/>
    <link rel="stylesheet" type="text/css"
          href="{{ asset('vendors/datatables/css/dataTables.bootstrap.css') }}"/>
    <link rel="stylesheet" type="text/css"
          href="{{ asset('vendors/datatables/css/rowReorder.bootstrap.css') }}"/>
    <link rel="stylesheet" type="text/css" href="{{ asset('vendors/datatables/css/buttons.bootstrap.css') }}">
                ...
                <div class="panel panel-primary filterable table-tools">
                    <div class="panel-heading clearfix  ">
                        <div class="panel-title pull-left">
                            <div class="caption">
                                <i class="material-icons">camera_alt</i> TableTools
                            </div>
                        </div>
                ...
                <div class="panel panel-success filterable">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="material-icons">reorder</i> Re-order Columns
                        </h3>
                    </div>
                    <div class="panel-body table-responsive">
                        <table class="table table-striped table-bordered display nowrap" id="table2" >
                            <thead>
                            <tr>
                                <th>#</th>
                                <th>First Name</th>
                ...
                <div class="panel panel-info filterable">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left add_remove_title">
                            <i class="material-icons">card_giftcard</i> Add / Remove rows
                        </h3>
                        <div class="pull-right">
                            <button type="button" class="btn btn-primary btn-sm adddel_btn" id="addButton">Add row
                            </button>
                            <button type="button" class="btn btn-danger btn-sm adddel_btn" id="delButton">Delete row
                            </button>
                        </div>
                    </div>
                    <div class="panel-body table-responsive">
                ...
                <div class="panel panel-warning filterable">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left">
                            <i class="material-icons">hourglass_full</i> Scroller
                        </h3>
                    </div>
                    <div class="panel-body table-responsive">
            ...
            <div class="col-lg-12">
                <div class="panel panel-primary filterable table-tools">
                    <div class="panel-heading clearfix  ">
                        <div class="panel-title pull-left">
                            <div class="caption">
                                <i class="material-icons">camera_alt</i> Inline Edit
                            </div>
                        </div>
                        <div class="tools pull-right"></div>
                    </div>
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{ asset('vendors/jeditable/js/jquery.jeditable.min.js') }}"></script>
