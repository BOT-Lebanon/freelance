                ...
                <div class="panel-heading buttons">
                    <div class="col-xs-6 btns">
                        <h3 class="panel-title">
                            <i class="material-icons">star_rate</i> X-Editable
                        </h3>
                    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="user" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" id="event" data-type="combodate" data-template="D MMM YYYY  HH:mm" data-placement="top" data-format="YYYY-MM-DD HH:mm" data-viewformat="MMM D, YYYY, HH:mm" data-pk="1" data-title="Setup event date and time" class="editable editable-click editable-empty">Empty</a>
                                </td>
                            </tr>
                            <tr>
                                <td>Textarea</td>
