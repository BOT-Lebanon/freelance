...
@section('content')
    ...
    <!-- date-range-picker -->
    <script src="{{ asset('vendors/autogrow/js/autogrow.min.js') }}"  type="text/javascript"></script>
    <script src="{{ asset('vendors/bootstrap-maxlength/js/bootstrap-maxlength.js') }}"  type="text/javascript"></script>
    <script src="{{ asset('vendors/card/dist/jquery.card.js') }}"  type="text/javascript"></script>
