...
@section('header_styles')
    ...
    <link href="{{ asset('vendors/materialdate/css/bootstrap-material-datetimepicker.css') }}" rel="stylesheet" type="text/css" />
...
<script src="{{ asset('vendors/materialdate/js/bootstrap-material-datetimepicker.js') }}" type="text/javascript"></script>
