...
{{-- Page title --}}
@section('title')
    Treeview and Jstree | Josh Admin Template
    @parent
@stop
{{-- page level styles --}}
@section('header_styles')
    <!--page level css -->
    <link rel="stylesheet" href="{{ asset('vendors/jstree/css/style.min.css') }}" />
    <link rel="stylesheet"  href="{{ asset('vendors/treeview/css/bootstrap-treeview.min.css') }}" />
    <link rel="stylesheet"  href="{{ asset('css/pages/treeview_jstree.css') }}" />
                            ...
                            <div class="population_tree">
                                ...
                                <form id="search">
                                    <div class="form-group is-empty">
                                        ...
                                        <button class="btn btn-raised btn-default" type="submit">Search</button>
                                    </div>
                                </form>
                                <div id="container3">
                                    <ul>
...
<script type="text/javascript" src="{{ asset('vendors/jstree/js/jstree.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('vendors/treeview/js/bootstrap-treeview.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/pages/treeview_jstree.js') }}"></script>
