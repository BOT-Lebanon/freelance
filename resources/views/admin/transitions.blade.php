    ...
    <div class="row animated">
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="material-icons">alarm</i> Attention Seekers
                    </h3>
                                <span class="pull-right clickable">
                                    <i class="material-icons">keyboard_arrow_up</i>
                                </span>
                ...
                <div class="panel-body text-center">
                    <!--content starts-->
                    <div class="wrap">
                                    <span id="animationSandbox1" class="">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="material-icons">card_membership</i> Bouncing Entrances
                    </h3>
                                <span class="pull-right clickable">
                                    <i class="material-icons">keyboard_arrow_up</i>
                                </span>
                ...
                <div class="panel-body text-center">
                    <!--content starts-->
                    <div class="wrap">
                                    <span id="animationSandbox2" class="">
                                        <span class="site__title mega">JOSH</span>
                                    </span>
                    </div>
                    <div class="wrap">
            ...
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="material-icons">format_quote</i> Bouncing Exits
                    </h3>
                                <span class="pull-right clickable">
                                    <i class="material-icons">keyboard_arrow_up</i>
                                </span>
                ...
                <div class="panel-body text-center">
                    <!--content starts-->
                    <div class="wrap">
                                    <span id="animationSandbox3" class="">
                                        <span class="site__title mega">JOSH</span>
                                    </span>
                    </div>
                    <div class="wrap">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="material-icons">security</i> Fading Entrances
                    </h3>
                                <span class="pull-right clickable">
                                    <i class="material-icons">keyboard_arrow_up</i>
                                </span>
                ...
                <div class="panel-body text-center">
                    <!--content starts-->
                    <div class="wrap">
                                    <span id="animationSandbox4" class="">
                                        <span class="site__title mega">JOSH</span>
                                    </span>
                    </div>
                    <div class="wrap">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="material-icons">repeat</i> Fading Exits
                    </h3>
                                <span class="pull-right clickable">
                                    <i class="material-icons">keyboard_arrow_up</i>
                                </span>
                ...
                <div class="panel-body text-center">
                    <!--content starts-->
                    <div class="wrap">
                                    <span id="animationSandbox5" class="">
                                        <span class="site__title mega">JOSH</span>
                                    </span>
                    </div>
                    <div class="wrap">
            ...
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="material-icons">shuffle</i> Flippers
                    </h3>
                                <span class="pull-right clickable">
                                    <i class="material-icons">keyboard_arrow_up</i>
                                </span>
                ...
                <div class="panel-body text-center">
                    <!--content starts-->
                    <div class="wrap">
                                    <span id="animationSandbox6" class="">
                                        <span class="site__title mega">JOSH</span>
                                    </span>
                    </div>
                    <div class="wrap">
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="material-icons">local_offer</i> Lightspeed
                    </h3>
                                <span class="pull-right clickable">
                                    <i class="material-icons">keyboard_arrow_up</i>
                                </span>
                ...
                <div class="panel-body text-center">
                    <!--content starts-->
                    <div class="wrap">
                                    <span id="animationSandbox7" class="">
                                        <span class="site__title mega">JOSH</span>
                                    </span>
                    </div>
                    <div class="wrap">
            ...
            <div class="panel panel-warning">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="material-icons">beach_access</i> Rotating Entrances
                    </h3>
                                <span class="pull-right clickable">
                                    <i class="material-icons">keyboard_arrow_up</i>
                                </span>
                ...
                <div class="panel-body text-center">
                    <!--content starts-->
                    <div class="wrap">
                                    <span id="animationSandbox8" class="">
                                        <span class="site__title mega">JOSH</span>
                                    </span>
                    </div>
                    <div class="wrap">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="material-icons">warning</i> Rotate Exits
                    </h3>
                                <span class="pull-right clickable">
                                    <i class="material-icons">keyboard_arrow_up</i>
                                </span>
                ...
                <div class="panel-body text-center">
                    <!--content starts-->
                    <div class="wrap">
                                    <span id="animationSandbox9" class="">
                                        <span class="site__title mega">JOSH</span>
                                    </span>
                    </div>
                    <div class="wrap">
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="material-icons">widgets</i> Sliders
                    </h3>
                                <span class="pull-right clickable">
                                    <i class="material-icons">keyboard_arrow_up</i>
                                </span>
                ...
                <div class="panel-body text-center">
                    <!--content starts-->
                    <div class="wrap">
                                    <span id="animationSandbox10" class="">
                                        <span class="site__title mega">JOSH</span>
                                    </span>
                    </div>
                    <div class="wrap">
            ...
            <div class="panel panel-warning">
                ...
                <div class="panel-body text-center">
                    <!--content starts-->
                    <div class="wrap">
                                    <span id="animationSandbox11" class="">
                                        <span class="site__title mega">JOSH</span>
                                    </span>
                    </div>
                    <div class="wrap">
