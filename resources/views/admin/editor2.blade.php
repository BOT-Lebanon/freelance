...
@section('footer_scripts')
    ...
    <script  src="{{ asset('vendors/summernote/summernote.js') }}"  type="text/javascript"></script>
    ...
    <script  src="{{ asset('vendors/trumbowyg/js/trumbowyg.pasteimage.min.js') }}"  type="text/javascript"></script>
    <script  src="{{ asset('vendors/trumbowyg/js/trumbowyg.preformatted.min.js') }}"  type="text/javascript"></script>
