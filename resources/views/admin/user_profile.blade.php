                            ...
                            <div class="panel-body">
                                <div class="col-md-3 col-xs-6">
                                    <div class="mag img-responsive">
                                        <br />
                                        <img data-toggle="magnify" class="thumbnail img-responsive" src="{{ asset('img/authors/avatar.jpg') }}" alt=""></div>
                                </div>
                                <div class="col-md-3 col-xs-6">
                                    <div class="mag img-responsive">
                                        <br />
                                        <img data-toggle="magnify" src="{{ asset('img/authors/avatar3.jpg') }}" alt="" class="thumbnail img-responsive"></div>
                                </div>
                                <div class="col-md-3 col-xs-6">
                                    <div class="mag img-responsive">
                                        <br />
                                        <img data-toggle="magnify" src="{{ asset('img/authors/avatar7.jpg') }}" alt="" class="thumbnail img-responsive"></div>
                                </div>
                                <div class="col-md-3 col-xs-6">
                                    <div class="mag img-responsive">
                                        <br />
                                        <img data-toggle="magnify" src="{{ asset('img/authors/avatar5.jpg') }}" alt="" class="thumbnail img-responsive"></div>
                                </div>
                                ...
                                <div class="col-md-3 col-xs-6">
                                    <div class="mag img-responsive">
                                        <br />
                                        <img data-toggle="magnify" src="{{ asset('img/authors/avatar4.jpg') }}" alt="" class="thumbnail img-responsive"></div>
                                </div>
                                <div class="col-md-3 col-xs-6">
                                    <div class="mag img-responsive">
                                        <br />
                                ...
                                <div class="col-md-3 col-xs-6">
                                    <div class="mag img-responsive">
                                        <br />
                                        <img data-toggle="magnify" src="{{ asset('img/authors/avatar2.jpg') }}" alt="" class="thumbnail img-responsive"></div>
                                </div>
                                <div class="col-md-3 col-xs-6">
                                    <div class="mag img-responsive">
                                        <br />
                                        <img data-toggle="magnify" src="{{ asset('img/authors/avatar.jpg') }}" alt="" class="thumbnail img-responsive"></div>
                                </div>
                                ...
                                <div class="col-md-3 col-xs-6">
                                    <div class="mag img-responsive">
                                        <br />
                                        <img data-toggle="magnify" class="thumbnail img-responsive" src="{{ asset('img/authors/avatar1.jpg') }}" alt=""></div>
                                </div>
                                <div class="col-md-3 col-xs-6">
                                    <div class="mag img-responsive">
                                        <br />
                            ...
                            <div class="activity">
                                <div class="imgs-profile">
                                    <a class="pull-left" href="#">
                                        <img class="media-object img-circle" src="{{ asset('img/authors/avatar.jpg') }}" alt=""></a>
                                ...
                                <div class="imgs-profile">
                                    <a class="pull-left" href="#">
                                        <img class="media-object img-circle" src="{{ asset('img/authors/avatar1.jpg') }}" alt=""></a>
                                    <div class="media-body">
                                        ...
                                        <div class="media blog-media">
                                            <a href="{{ asset('img/authors/avatar2.jpg') }}" data-rel="prettyPhoto">
                                                <img src="{{ asset('img/authors/avatar2.jpg') }}" class="thumbnail img-responsive" alt=""></a>
                                ...
                                <div class="imgs-profile">
                                    <a href="img/authors/avatar3.jpg" class="boxer pull-left">
                                        <img class="media-object" src="{{ asset('img/authors/avatar3.jpg') }}" alt=""></a>
                                    <div class="media-body">
                                ...
                                <div class="imgs-profile">
                                    <a class="pull-left" href="#">
                                        <img class="media-object img-circle" src="{{ asset('img/authors/avatar4.jpg') }}" alt=""></a>
                                    <div class="media-body">
                                        ...
                                        <ul class="uploadphoto-list">
                                            ...
                                            <li>
                                                <a href="{{ asset('img/authors/avatar3.jpg') }}" data-rel="prettyPhoto">
                                                    <img src="{{ asset('img/authors/avatar3.jpg') }}" class="thumbnail img-responsive" alt=""></a>
                                            </li>
                                            <li>
                                                <a href="{{ asset('img/authors/avatar.jpg') }}" data-rel="prettyPhoto">
                                                    <img src="{{ asset('img/authors/avatar.jpg') }}" class="thumbnail img-responsive" alt=""></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="imgs-profile">
                                    <a class="pull-left" href="#">
                                        <img class="media-object img-circle" src="{{ asset('img/authors/avatar7.jpg') }}" alt=""></a>
                                    <div class="media-body">
                                ...
                                <div class="imgs-profile">
                                    <a class="pull-left" href="#">
                                        <img class="media-object img-circle" src="{{ asset('img/authors/avatar2.jpg') }}" alt=""></a>
                                ...
                                <div class="imgs-profile">
                                    <a class="pull-left" href="#">
                                        <img class="media-object img-circle" src="{{ asset('img/authors/avatar3.jpg') }}" alt=""></a>
                                    <div class="media-body">
                                        ...
                                        <div class="media blog-media">
                                            <a class="pull-left" href="#">
                                                <img class="media-object thumbnail" src="{{ asset('img/authors/avatar4.jpg') }}" alt=""></a>
                                            <div class="media-body col-md-8 col-lg-8 col-sm-8 col-xs-12">
                                                <h4 class="media-title">
                                                    <a href="">
