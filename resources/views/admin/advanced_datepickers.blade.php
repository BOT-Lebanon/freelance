...
@section('header_styles')
    ...
    <link href="{{ asset('vendors/air-datepicker/css/datepicker.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('vendors/flatpickr-calendar/css/flatpickr.min.css') }}" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" href="{{ asset('css/pages/datepicker.css') }}">
@stop
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control flatpickr" id="min_max">
                            </div>
                        </div>
                        <!-- /.input group -->
                        <!-- /.form group -->
...
<script src="{{ asset('vendors/flatpickr-calendar/js/flatpickr.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('vendors/air-datepicker/js/datepicker.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('vendors/air-datepicker/js/datepicker.en.js') }}" type="text/javascript"></script>
