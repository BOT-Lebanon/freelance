                ...
                <div class="panel panel-info" style="overflow-y:auto; overflow-x: hidden">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="material-icons">file_upload</i> File Drop Zone
                        </h3>
                    </div>
                    <div class="panel-body" style="padding:0px !important;">
                        ...
                        <div class="col-md-12" style="padding:30px;">
                            {!! Form::open(array('url' => URL::to('admin/file/create'), 'method' => 'post', 'id'=>'myDropzone','name'=>'file','class' => 'dropzone', 'files'=> true)) !!}
                            <div class="fallback">
<<<<<<< HEAD
