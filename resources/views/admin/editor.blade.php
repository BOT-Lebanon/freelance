...
@section('content')
    ...
    <section class="content paddingleft_right15">
                ...
                <div class="panel-heading">
                    <div class="text-muted bootstrap-admin-box-title editor-clr">
                        <h3 class="panel-title">
                            <i class="material-icons">local_offer</i> CKEditor Standard</h3>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="text-muted bootstrap-admin-box-title editor-clr">
                        <h3 class="panel-title">
                            <i class="material-icons">usb</i> CKEditor Full</h3>
                    </div>
                </div>
                <div class="bootstrap-admin-panel-content">
        ...
        <div class="row">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <div class="text-muted bootstrap-admin-box-title editor-clr">
                        <h3 class="panel-title">
                            <i class="material-icons">extension</i> TinyMCE Basic</h3>
                    </div>
                </div>
                <div class="bootstrap-admin-panel-content">
        ...
        <div class="row">
            <div class="panel panel-warning">
                <div class="panel-heading">
                    <div class="text-muted bootstrap-admin-box-title editor-clr">
                        <h3 class="panel-title">
                            <i class="material-icons">beach_access</i> TinyMCE Full</h3>
                    </div>
                </div>
                <div class="bootstrap-admin-panel-content">
        ...
        <div class="row">
            <div class="panel panel-default filterable">
                <div class="panel-heading">
                    <h3 class="panel-title ">
                        <i class="material-icons">edit</i> Inline Editing
                    </h3>
                </div>
    ...
    <script  src="{{ asset('js/pages/editor1.js') }}"  type="text/javascript"></script>
