...
@section('header_styles')
    ...
    <link href="{{ asset('vendors/c3/c3.min.css') }}" rel="stylesheet" type="text/css"/>
...
@section('footer_scripts')
    ...
    <script language="javascript" type="text/javascript"
            src="{{ asset('vendors/flotchart/js/jquery.flot.pie.js') }}"></script>
    <script language="javascript" type="text/javascript"
    ...
    <script language="javascript" type="text/javascript"
            src="{{ asset('vendors/d3pie/d3pie.min.js') }}"></script>
    <script language="javascript" type="text/javascript" src="{{ asset('vendors/c3/c3.min.js') }}"></script>
    <script language="javascript" type="text/javascript"
            src="{{ asset('vendors/morrisjs/morris.min.js') }}"></script>
    <script language="javascript" type="text/javascript"
            src="{{ asset('vendors/raphael/js/raphael-min.js') }}"></script>
    <script language="javascript" type="text/javascript"
            src="{{ asset('js/pages/custompiecharts.js') }}"></script>
