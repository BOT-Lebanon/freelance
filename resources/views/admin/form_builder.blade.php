...
@section('header_styles')
    ...
    <link href="{{ asset('vendors/bootstrap-form-builder/css/custom.css') }}" rel="stylesheet" />
...
<script data-main="{{ asset('vendors/bootstrap-form-builder/js/main-built.js') }}" src="{{ asset('vendors/bootstrap-form-builder/js/lib/require.js') }}" ></script>
