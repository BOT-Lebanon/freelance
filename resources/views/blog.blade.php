    ...
    <div class="breadcum">
        <div class="container">
            ...
            <div class="pull-right">
                <i class="fa fa-pencil-square-o icon3 " ></i> Blog
            </div>
        </div>
    </div>
    @stop
                                ...
                                <div class="tab-pane active" id="tab_default_1">
                                    <div class="media">
                                        <div class="media-left tab col-sm-6 col-md-12 col-xs-12">
                                            <a href="#">
                                                <img class="media-object img-responsive" src="{{ asset('images/img_3.jpg') }}" alt="image">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="media">
                                        <div class="media-left tab col-sm-6 col-md-12 col-xs-12">
                                            <a href="#">
                                                <img class="media-object img-responsive" src="{{ asset('images/img_5.jpg') }}" alt="image">
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <ul class="media-list media-xs media-dotted">
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img src="{{ asset('images/authors/avatar.jpg') }}" class="img-circle img-responsive pull-left" alt="riot">
                                </a>
                            ...
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img src="{{ asset('images/authors/avatar1.jpg') }}" class="img-circle img-responsive pull-left" alt="riot">
                                </a>
                                <div class="media-body">
                                    <h4 class="media-heading primary">
                            ...
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img src="{{ asset('images/authors/avatar5.jpg') }}" class="img-circle img-responsive pull-left" alt="riot">
                                </a>
                                <div class="media-body">
                                    <h4 class="media-heading primary">
