    ...
    <div class="breadcum">
        <div class="container">
            ...
            <div class="pull-right">
                ...
                {{--<i class="livicon icon3" data-name="list-ul" data-size="20" data-loop="true" data-c="#3d3d3d" data-hc="#3d3d3d"></i>--}}
                News Item
            </div>
        </div>
    </div>
                ...
                <div class="the-box  no-margin more-padding martop3 ">
                    ...
                    <div class="row">
                        <div class="col-xs-3">
                            <p>
                                <a href="#">
                                    <img src="{{ asset('images/authors/avatar.jpg') }}" class="img-responsive img-circle" alt="riot">
                                </a>
                            </p>
                        </div>
                        <!-- /.col-xs-3 -->
                        <div class="col-xs-3">
                            <p>
                                <a href="#">
                                    <img src="{{ asset('images/authors/avatar1.jpg') }}" class="img-responsive img-circle" alt="riot">
                                </a>
                            </p>
                        </div>
                        <!-- /.col-xs-3 -->
                        <div class="col-xs-3">
                            <p>
                                <a href="#">
                                    <img src="{{ asset('images/authors/avatar2.jpg') }}" class="img-responsive img-circle" alt="riot">
                                </a>
                            </p>
                        </div>
                        <!-- /.col-xs-3 -->
                        <div class="col-xs-3">
                            <p>
                                <a href="#">
                                    <img src="{{ asset('images/authors/avatar3.jpg') }}" class="img-responsive img-circle" alt="riot">
                                </a>
                            </p>
                        </div>
                        <!-- /.col-xs-3 -->
                    ...
                    <div class="tab-pane active" id="tab_default_1">
                        <div class="media">
                            <div class="media-left">
                                <a href="#">
                                    <img class="media-object" src="{{ asset('images/image_13.jpg') }}" alt="image">
                                </a>
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="media-left">
                                <a href="#">
                                    <img class="media-object" src="{{ asset('images/image_14.jpg') }}" alt="image">
                                </a>
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="media-left">
                                <a href="#">
                                    <img class="media-object" src="{{ asset('images/image_15.jpg') }}" alt="image">
                                </a>
                            </div>
                            <div class="media-body">
                                <a href="#"><h5 class="media-heading text-primary">Efficiently unleash cross-media information without cross-media value.</h5></a>
