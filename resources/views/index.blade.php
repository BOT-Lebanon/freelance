...
@section('top')
    ...
    <div id="owl-demo" class="owl-carousel owl-theme">
        <div class="item"><img src="{{ asset('images/slide_1.jpg') }}" alt="slider-image">
        </div>
        <div class="item"><img src="{{ asset('images/slide_2.jpg') }}" alt="slider-image">
        </div>
        <div class="item"><img src="{{ asset('images/slide_4.png') }}" alt="slider-image">
        </div>
    </div>
    <!-- //Carousel End -->
@stop
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-3 wow bounceInLeft" data-wow-duration="3.5s">
                <div class="box">
                    <div class="box-icon">
                        <i class="fa fa-desktop text-success icon1"></i>
                    </div>
                    <div class="info">
            ...
            <div class="col-sm-6 col-md-3 wow bounceInDown" data-wow-duration="3s" data-wow-delay="0.4s">
                ...
                <div class="box">
                    <div class="box-icon box-icon1">
                        <i class="fa fa-cogs text-primary icon1"></i>
                    </div>
                    <div class="info">
            ...
            <div class="col-sm-6 col-md-3 wow bounceInUp" data-wow-duration="3s" data-wow-delay="0.8s">
                <div class="box">
                    <div class="box-icon box-icon2">
                        <i class="fa fa-file-o warning icon1"></i>
                    </div>
                    <div class="info">
            ...
            <div class="col-sm-6 col-md-3 wow bounceInRight" data-wow-duration="5s" data-wow-delay="1.2s">
                <div class="box">
                    <div class="box-icon box-icon3">
                        <i class="fa fa-cogs yellow icon1"></i>
                    </div>
                    <div class="info">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12 wow zoomIn" data-wow-duration="2s">
                    <div class="layout-image">
                        <img src="{{ asset('images/layout.png') }}" alt="layout" class="img-responsive" />
                    </div>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-12 wow lightSpeedIn" data-wow-duration="2s">
                    <ul class="list-unstyled pull-right text-right layout-styl">
                        <li>
                            <i class="fa fa-check-square-o text-success"></i> Responsive clean design
                        </li>
                        <li><i class="fa fa-check-square-o text-success"></i> User friendly </li>
                        <li><i class="fa fa-check-square-o text-success"></i> HTML5 </li>
                        <li><i class="fa fa-check-square-o text-success"></i> CSS3 </li>
                        <li><i class="fa fa-check-square-o text-success"></i> Bootstrap 3.3.4 </li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_default_1">
                                <div class="media">
                                    <div class="media-left tab col-sm-12">
                                        <a href="#">
                                            <img class="media-object img-responsive" src="{{ asset('images/authors/img1.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                </div>
                                <p>
                            ...
                            <div class="tab-pane" id="tab_default_2">
                                <div class="media">
                                    <div class="media-left media-middle tab col-sm-12">
                                        <a href="#">
                                            <img class="media-object img-responsive" src="{{ asset('images/authors/img2.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                </div>
                                <p>
                            ...
                            <div class="tab-pane" id="tab_default_3">
                                <div class="media">
                                    <div class="media-left media-middle tab col-sm-12">
                                        <a href="#">
                                            <img class="media-object img-responsive" src="{{ asset('images/authors/img3.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                </div>
                                <p>
                            ...
                            <div class="tab-pane" id="tab_default_4">
                                <div class="media">
                                    <div class="media-left media-middle tab col-sm-12">
                                        <a href="#">
                                            <img class="media-object img-responsive" src="{{ asset('images/authors/img4.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                </div>
                                <p>
        ...
        <div class="row text-center">
            ...
            <div class="col-md-3 col-sm-5 profile wow fadeInLeft"  data-wow-duration="3s" data-wow-delay="0.5s">
                <div class="thumbnail bg-white">
                    <img src="{{ asset('images/img_3.jpg') }}" alt="team-image" class="img-responsive">
                    <div class="caption">
                        <b>John Doe</b>
            ...
            <div class="col-md-3 col-sm-5 profile wow fadeInDown" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class="thumbnail bg-white">
                    <img src="{{ asset('images/img_4.jpg') }}" alt="team-image" class="img-responsive">
                    <div class="caption">
                        <b>Audrey Sheldon</b>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 wow zoomInLeft" data-wow-duration="3s">
                ...
                <img src="{{ asset('images/image_12.jpg') }}" alt="image_12" class="img-responsive">
                <p>
            ...
            <div class="col-md-6 col-sm-6 wow zoomInRight" data-wow-duration="3s">
                ...
                <img src="{{ asset('images/image_11.jpg') }}" alt="image_11" class="img-responsive">
                <p>
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                </p>
                <p class="text-right primary"><a href="#">Read more</a>
        ...
        <div class="row">
            ...
            <div class="col-md-4 wow bounceInLeft" data-wow-duration="3s">
                <div class="author">
                    <img src="{{ asset('images/authors/avatar3.jpg') }}" alt="avatar3" class="img-responsive img-circle pull-left">
                    <p class="text-right">
                        Tonny Jakson
                        <br>
            ...
            <div class="col-md-4 wow bounceIn" data-wow-duration="3s">
                <div class="author">
                    <img src="{{ asset('images/authors/avatar2.jpg') }}" alt="avatar2" class="img-responsive img-circle pull-left">
                    <p class="text-right">
                        Tonny Jakson
                        <br>
                        <small class="text-right">Themeforest.net</small>
            ...
            <div class="col-md-4 wow bounceInRight" data-wow-duration="3s">
                <div class="author">
                    <img src="{{ asset('images/authors/avatar4.jpg') }}" alt="avatar4" class="img-responsive img-circle pull-left">
                    <p class="text-right">
                        Tonny Jakson
                        <br>
                        <small class="text-right">Themeforest.net</small>
        ...
        <div class="row features">
            ...
            <div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-duration="3s" data-wow-delay="0.5s">
                <div>
                    <a href="#"><i class="fa fa-check-square-o text-primary"></i></a>
                ...
                <div>
                    <a href="#"> <i class="fa fa-check-square-o yellow"></i>
                    </a>
                    <h4>Html 5</h4>
                    <p>
                        <label>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."</label>
            ...
            <div class="col-md-4 col-sm-4 wow fadeInDown" data-wow-duration="3s" data-wow-delay="0.5s">
                ...
                <div>
                    <a href="#"> <i class="fa fa-check-square-o text-warning"></i>
                    </a>
                    <h4>Css</h4>
                    <p>
                        <label>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."</label>
            ...
            <div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-duration="3s" data-wow-delay="0.5s">
                <div>
                    <a href="#"><i class="fa fa-check-square-o text-danger"></i>
                    </a>
                    <h4>Clean Design</h4>
                    <p>
                        <label>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."</label>
                ...
                <div>
                    <a href="#"><i class="fa fa-check-square-o text-info"></i>
                    </a>
                    <h4>Bootstrap</h4>
                    <p>
                        <label>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."</label>
