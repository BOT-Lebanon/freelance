    ...
    <div class="breadcum">
        <div class="container">
            ...
            <div class="pull-right">
                ...
                {{--<i class="livicon icon3" data-name="doc-landscape" data-size="20" data-loop="true" data-c="#3d3d3d" data-hc="#3d3d3d"></i>--}}
                Blog Item
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-4 col-md-4 col-full-width-left">
                <div class="the-box">
                        ...
                        <ul class="media-list media-xs media-dotted">
                            ...
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img src="{{ asset('images/authors/avatar4.jpg') }}" class="img-circle img-responsive pull-left" alt="riot">
                                </a>
                                <div class="media-body">
                                    <h4 class="media-heading primary">
