    ...
    <div class="breadcum">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="hidden-xs">
                    <i class="material-icons icon3 text-success"></i>
                    <a href="#">About Us</a>
                </li>
            </ol>
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-sm-12 slider wow fadeInRightBig" data-wow-duration="5s">
                <div id="owl-demo" class="owl-carousel owl-theme">
                    <div class="item"><img src="{{ asset('images/image_16.jpg') }}" alt="slider-image">
                    </div>
                    <div class="item"><img src="{{ asset('images/image_17.jpg') }}" alt="slider-image">
                    </div>
                    <div class="item"><img src="{{ asset('images/image_16.jpg') }}" alt="slider-image">
                    </div>
                </div>
